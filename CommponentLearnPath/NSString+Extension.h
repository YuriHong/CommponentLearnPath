...
/**
 ...
 @param str 加密的原文  若是解密则传16进制编码密文
 @param key 密钥
 @param isEncrypt YES = 加密 NO = 解密
 @return 加密后的16进制编码密文。解密后的原文
 */
...
// 解决IDS 第三方登录的问题
+ (NSString * _Nullable)getRealName:(NSString *_Nonnull)userName;

// 转化为HTML string
- (NSString * _Nullable)HTMLString;
